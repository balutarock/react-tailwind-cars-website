const Home = () => {
    return <div>
        ...
        {/* Cars Section */}
        <section className="container mx-auto px-40 p-10">
            <h2 className="text-4xl font-bold text-center text-gray-800 mb-10">
                Cars & Bikes
            </h2>
            <div className="flex justify-center items-center flex-wrap mb-20 py-10 border-solid border-2 border-indigo-500 rounded-lg shadow-lg">
            ...
            <div className="bg-gradient-to-r from-pink-100 via-pink-200 to-orange-200 flex justify-center items-center flex-wrap mb-20 py-10 border-solid border-2 border-indigo-500 rounded-lg shadow-lg">
                <div className="w-full md:w-1/4">
                    <img src="https://res.cloudinary.com/dxnhvq8pl/image/upload/v1686075450/Gopi/Website/modern-sport-car-illustration_232942-45-removebg-preview_coahio.png" alt="Reporting" />
                </div>
            ...
            <div className="flex justify-center items-center flex-wrap mb-20 py-10 border-solid border-2 border-indigo-500 rounded-lg shadow-lg">
                ...
                <div className="w-full md:w-1/4">
                    <img src="https://res.cloudinary.com/dxnhvq8pl/image/upload/v1686075450/Gopi/Website/modern-sport-car-illustration_232942-45-removebg-preview_coahio.png" alt="Syncing" />
                </div>
            </div>
        </section>
        {/* Testimonial */}
